...
- [Decentralized Web Node Companion Guide (DWN)](#decentralized-web-node-companion-guide-dwn)
  - [Overview](#overview)
    - [What Are Decentralized Web Nodes?](#what-are-decentralized-web-nodes)
  ...
  - [Node Discovery and Peer-to-Peer Networking](#node-discovery-and-peer-to-peer-networking)
  - [Data Sharing and Interoperability](#data-sharing-and-interoperability)
  - [Security and Privacy](#security-and-privacy)
    - [Security](#security)
      - [Security Risks and Mitigation Strategies](#security-risks-and-mitigation-strategies)
...
While DWN's are GDPR by default, a malicious actor may still implement various
attacks on the DWN. The following section describes some of the possible
attacks, and the possible mitigation strategies you can implement to reduce your
risk.

We assume some "guidance" on impact levels for each of these attack vectors, but
please keep in mind that every deployment is different, and so what may be
important to most implementations may not be as important for you.

#### Security Risks and Mitigation Strategies

| Name              | Description | Impact                                    | Level    | Mitigation                                                     |
| ----------------- | ----------- | ----------------------------------------- | -------- | -------------------------------------------------------------- |
| Compromised Keys  |             | Data is no longer confidential and secure | Critical | Trust a good key management layer with revocation capabilities |
| Exposed Metadata  |             |                                           |          |                                                                |
| Man in the Middle |             |                                           |          |                                                                |
| DDOS              |             |                                           |          |                                                                |
...
The following question and answers have been collected over time by the DIF
Working Group. These are common questions we see people asking about DWN's.
